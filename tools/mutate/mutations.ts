...
function physicallyAbsurdViolations_unused(`,
  ...
  },
  {
    ...
    file: `${K}/piezo-reconcile.ts`,
    find: '  const instHalf = Math.min(instrumentHalfX, instrumentHalfY)',
    replace: '  const instHalf = Math.max(instrumentHalfX, instrumentHalfY)',
    scope: 'packages/host',
  },
  {
    ...
    find: '  return on && excitationV > 0.0',
