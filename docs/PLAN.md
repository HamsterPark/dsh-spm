...
> **阅读定位**：本文保存总体设计、阶段目标及其修订背景，包含各决策时点的规模和环境数据。当前能力从 [README](../README.md) 与 [运行指南](README.md#选择运行方式) 查看，当前工作约定见 [AGENTS.md](../AGENTS.md) 和 [DEVELOPMENT.md](DEVELOPMENT.md)。本文早期的数量、课时节奏与版本描述不作为当前状态声明。
