...
As of the 2026-09-21 readiness check, the existing repository had not been renamed and the new independent repository had not been created. Its final visibility change remains a publication action under the owner's instruction. The [release checklist](RELEASE-TODO.md) records the remaining sequence and the later work still to assemble into the candidate.
