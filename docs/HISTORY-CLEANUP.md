...
The [final preparation record](handoff/publication-ready-20260921.md) separates the tested code candidate from later documentation-only updates. The [release checklist](RELEASE-TODO.md) retains public visibility and its anonymous verification as the remaining publication action.
