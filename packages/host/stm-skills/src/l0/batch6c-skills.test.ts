...
import { EDGE_RESOLUTION_REL_TOL, instabilityAbsTol } from 'dsh-spm-vision'
import { SPECTRO_REL_TOL } from 'dsh-spm-vision'
import { decayLengthRelTol, forceAbsTolFactor } from 'dsh-spm-vision'
